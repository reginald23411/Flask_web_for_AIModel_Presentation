...
layui.use(['layer','element','jquery'],function() {
    ...
    const SMALL_WIDTH = "66px";
    const NORMAL_WIDTH = "220px";
    $('.left-nav #nav').on('click', 'li', function(event) {
        ...
        if(width==SMALL_WIDTH || width==ZERO_WIDTH){
          $('.left-nav').animate({width: NORMAL_WIDTH}, 100);
          $('.page-content').animate({left: NORMAL_WIDTH}, 100);
    ...
    $('.left-nav #nav').on('mouseenter', '.left-nav-li', function(event) {
      if($('.left-nav').css('width')!=NORMAL_WIDTH){
    ...
    $('.container .left_open i').click(function(event) {
        if($('.left-nav').css('width')==NORMAL_WIDTH){
            ...
            // $('.left-nav').animate({width: SMALL_WIDTH}, 100);
            $('.left-nav').animate({width: ZERO_WIDTH}, 100);
            $('.left-nav cite,.left-nav .nav_right').hide();
            // $('.page-content').animate({left: SMALL_WIDTH}, 100);
            $('.page-content').animate({left: ZERO_WIDTH}, 100);
